...
describe('ReciveComponent', () => {
  ...
  let mockReciveService;
  let mockDataService

  beforeEach(async(() => {

    mockReciveService = sinon.createStubInstance(ReciveService);
    mockReciveService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ReciveService, useValue: mockReciveService },
